...
const Footer = () => {
    ...
    return (
        <footer className="bg-white pt-17.5">
            <div className="container">
                <div className="grid pb-15 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
                    <div className='flex flex-col space-y-2'>
                        <h2 className="text-2xl font-semibold text-gray-700">Help & Support</h2>
                        <ul className="space-y-3 mt-3">
                            <li className="flex gap-4.5 font-medium text-gray-500">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                        ...
                        <div className="flex space-x-4 mt-8">
                            <a
                                ...
                                className="flex ease-out duration-200 hover:text-blue-700"
                            >
                                <svg
                    ...
                    <div className='flex flex-col space-y-2'>
                        ...
                        <ul className="flex flex-col space-y-3 mt-3.5">
                            <li className="flex gap-4.5 font-medium text-gray-500 ">
                    ...
                    <div className='flex flex-col space-y-2'>
                        <h2 className="text-2xl font-semibold text-gray-700">Quick Link</h2>
                    ...
                    <div className='flex flex-col space-y-2 lg:items-end'>
                        <h2 className="text-2xl font-semibold  text-gray-700">Download App</h2>


                        <ul className="flex flex-col space-y-3 mt-3.5">
                            <li className="flex gap-4.5 font-md text-gray-500 ">
                        ...
                        <ul className="flex flex-col mt-3 gap-3">
                            <li className="w-[200px]">
                                <a
                                    className="inline-flex items-center w-full gap-3 py-[9px] pl-4 pr-7.5 text-white rounded-md bg-black ease-out duration-200 hover:bg-opacity-95"
                                    href="#"
                                >
                                    <svg
                                        className="fill-current"
                            ...
                            <li className="w-[200px]">
                                <a
                                    className="inline-flex items-center gap-3 w-full py-[9px] pl-4 pr-8.5 text-white rounded-md bg-blue-600 ease-out duration-200 hover:bg-opacity-95"
                                    href="#"
                                >
                                    <svg
                                        className="fill-current"
            ...
            <div className=" bg-gray-100">
                <div className="container">
                    <div className="flex gap-5 flex-wrap py-7 items-center justify-between">
                        <p className="text-dark font-medium">
                            &copy; {year}. All rights reserved by Mohamed Gamal.
                        </p>
