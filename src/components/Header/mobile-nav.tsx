        ...
        <Sheet>
            ...
            <SheetContent>
                <SheetHeader>
                    ...
                    <SheetClose asChild>
                        <Link href={"/login"}>
                            <div className="my-2 flex space-x-1 hover:bg-indigo-100 py-2 duration-300 hover:rounded-md  items-center justify-center">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                    ...
                    <SheetClose asChild>
                        <Link href={"/cart"}>
                            <div className=" flex space-x-1 hover:bg-indigo-100 py-2 duration-300 hover:rounded-md  items-center justify-center">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
