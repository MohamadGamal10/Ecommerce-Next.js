...
opacity-0 translate-y-4 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:translate-y-0'>
            <button
                ...
                className="flex items-center justify-center w-9 h-9  rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-blue-500"
            >
                <svg
            ...
            <Button
                ...
                className="inline-flex font-medium text-sm px-5 rounded-[5px] bg-blue-700 text-white ease-out duration-200 hover:bg-blue-600"
            >
                Add to cart
            </Button>
