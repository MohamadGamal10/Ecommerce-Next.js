        ...
        <div className="group flex mx-auto w-full">
            ...
            <div className="flex flex-col w-full ">
                <div className='relative bg-gray-100 w-full h-full py-auto p-1 rounded-md '>
                    ...
                    <Image className='my-auto mx-auto p-12' src={`${process.env.NEXT_PUBLIC_API_URL}/products/${product.imageCover}`} width={250} height={250} alt="product" />
